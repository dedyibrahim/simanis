...
<div class="section-title">Daftar Akta</div>
<table class="data-table">
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="5" class="empty-state">Tidak ada data notaris untuk periode ini.</td>
            </tr>
        @endforelse
    </tbody>
</table>
